...
function restartGame() {
    ...
    villainCharacter = null;
    villainsDied = 0;
    Characters = [new Character("hermione", "Hermione", "assets/images/Hermione.jpg", 785, 20, 40), new Character("harry-potter", "Harry Potter", "assets/images/Harry_Potter.jpg", 810, 15, 60), new Character("voldemort", "Voldemort", "assets/images/Voldemort.jpg", 950, 10, 70), new Character("bellatrix", "Bellatrix", "assets/images/Bellatrix.jpg", 725, 20, 30),];
    $("#reset").hide();
    $("#counter-death").empty();
    for (var i = 0; i < Characters.length; i++) {
